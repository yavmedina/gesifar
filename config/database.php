...
// ============================================
// Este archivo es para la base de datos de producción
// cuando no se usa, renombrar a database-produccion.php
...
define('DB_NAME', 'gesifar');   // gesifar para produccion, farmhos para testing
