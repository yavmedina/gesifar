    ...
    if(empty($nombre) || empty($tipo) || $id_proveedor == 0) {
        ...
        try {
            ...
            $query = "INSERT INTO material (
                ...
                tipo, id_forma_farmaceutica, id_presentacion, id_proveedor,
                activo
            ) VALUES (
                :codigo, :nombre, :nombre_comercial, :principio_activo, :concentracion,
...
<head>
 ...
 <!-- script de Lau Schell para bloquear menú desplegable cuando se elige insumo -->
    <script>
...
<!-- fin del script de bloqueo menú desplegable -->
