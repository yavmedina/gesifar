<!--
presentaciones version 2
Lau, basta de modificaciones!!!!
-->
...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion'])) {
    if($_POST['accion'] == 'agregar') {
        ...
        if($id_presentacion == 0 || $factor <= 0) {
            $error = "Complete todos los campos correctamente";
        } else {
            try {
                $query = "INSERT INTO presentacion_material (id_material, id_presentacion, factor_conversion, activo) 
                          VALUES (:id_material, :id_pres, :factor, 1)";
                $stmt = $db->prepare($query);
            ...
            <form method="POST" action="">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <small>¿Cuántas unidades base contiene? (Ej: 50 para Caja x 50 comprimidos)</small>
                    </div>
                </div>
                
                <div class="info-box">
                    <strong>Ejemplo:</strong> Si la presentación es "Caja x 50 comprimidos", el factor debe ser <strong>50</strong>
                </div>
