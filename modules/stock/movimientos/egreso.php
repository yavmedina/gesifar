...
// Guardar área de destino
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion']) && $_POST['accion'] == 'set_area') {
    $_SESSION['area_destino'] = (int)$_POST['id_area_destino'];
    $_SESSION['observaciones'] = trim($_POST['observaciones']);
    $mensaje = "Área de destino confirmada";
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion']) && $_POST['accion'] == 'finalizar') {
    $id_area_destino = $_SESSION['area_destino'];
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST">
                <input type="hidden" name="accion" value="set_area">
                ...
                <div class="form-grid">
                        ...
                        <select name="id_area_destino" required>
                            ...
                            <?php foreach($areas as $area): ?>
                                <option value="<?php echo $area['id_area']; ?>" 
                                    <?php echo (isset($_SESSION['area_destino']) && $_SESSION['area_destino'] == $area['id_area']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="observaciones" rows="2"><?php echo isset($_SESSION['observaciones']) ? htmlspecialchars($_SESSION['observaciones']) : ''; ?></textarea>
                    </div>
                </div>
        ...
        <?php if(!isset($_SESSION['area_destino'])): ?>
            <div class="info-box" style="margin-top: 20px;">
                <strong>⚠️ Debe seleccionar el área de destino antes de agregar materiales</strong>
            </div>
        <?php else: ?>
            <div class="alert alert-success" style="margin-top: 20px;">
                <strong>✓ Área seleccionada:</strong> 
                <?php 
                $area_sel = array_filter($areas, function($a) { return $a['id_area'] == $_SESSION['area_destino']; });
                echo $area_sel ? htmlspecialchars(reset($area_sel)['descripcion']) : '';
                ?>
            </div>
        <?php endif; ?>
        ...
        <?php endif; ?> <!-- Fin if área seleccionada -->
