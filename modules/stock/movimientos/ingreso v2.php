        ...
        try {
            ...
            foreach($todos_items as $item) {
                ...
                $query_lote = "INSERT INTO lotes_material (
                    id_material, numero_lote, fecha_ingreso, fecha_vencimiento,
                    cantidad_inicial, cantidad_actual, id_proveedor, estado
                ) VALUES (
                    :material, :lote, CURDATE(), :venc, :cant, :cant, :prov, 'disponible'
                )";
...
<body>
    ...
    <div class="container">
        ...
        <?php if(isset($_GET['limpiar'])): ?>
            <?php unset($_SESSION['ingreso_temp']); header("Location: ingreso.php"); exit(); ?>
        <?php endif; ?>
